    ...
    CommandLineRunner initData(
        ...
        return new CommandLineRunner() {
            ...
            public void run(String... args) throws Exception {
                ...
                Member memberUser6ByKakao = memberService.whenSocialLogin("KAKAO", "KAKAO__2736347876").getData();
                Member memberUser7ByGoogle = memberService.whenSocialLogin("GOOGLE", "GOOGLE__105369912104600343421").getData();
                Member memberUser8ByNaver = memberService.whenSocialLogin("NAVER", "NAVER__mPLizfI1X5n9EIBMmNHCt8wSAtyX2L5AiDtRDVJO7S4").getData();
                Member memberUser9ByFacebook = memberService.whenSocialLogin("FACEBOOK", "FACEBOOK__4221330581425506").getData();
